-- Fix the initialization function to handle user_achievements insertion properly
-- The unique constraint exists, but we need to ensure the function works correctly
