-- Simple achievement check and view creation

-- Drop the view if it exists
DROP VIEW IF EXISTS v_user_achievement_state;

-- Create a simple view to check user achievements
CREATE VIEW v_user_achievement_state AS
SELECT 
    u.email,
    u.id as user_id,
