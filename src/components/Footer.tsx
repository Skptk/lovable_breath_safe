...
export default function Footer() {
  ...
  if (!user) {
    return (
      <motion.footer 
        className="bg-card border-t border-border mt-auto backdrop-blur-sm pb-safe w-full"
  ...
  return (
    <motion.footer 
      className="bg-card border-t border-border mt-auto backdrop-blur-xl pb-safe w-full"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6, ease: "easeOut" }}
      style={{ paddingBottom: 'max(1.5rem, env(safe-area-inset-bottom))' }}
